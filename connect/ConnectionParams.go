...
//	Parameters: values map[string]string an object to be
...
//	Parameters: tuples ...any the tuples to fill a new ConnectionParams object.
...
//	Parameters: line string a string with serialized key-value pairs as
...
//	Parameters: config *config.ConfigParams a configuration parameters to retrieve connections
...
//	Parameters: config *config.ConfigParams ConnectionParams, containing a section named "connection(s)".
...
//	Parameters: value string a new key to retrieve connection.
...
//	Parameters: defaultValue string the default protocol
//	Returns: string the connection protocol or the default value if it's not set.
...
//	Parameters: value string a new connection protocol.
...
//	Parameters: value string a new host name or IP address.
...
//	Parameters: defaultValue int default port number
//	Returns: int the port number.
...
//	Parameters: value string a new resource URI or connection string.
