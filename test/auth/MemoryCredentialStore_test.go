...
func TestLookupAndStore(t *testing.T) {
	...
	cred1, _ := credentialStore.Lookup(context.Background(), "123", "key1")
	cred2, _ := credentialStore.Lookup(context.Background(), "123", "key2")
	...
	credentialStore.Store(context.Background(), "123", "key3", credConfig)

	cred3, _ := credentialStore.Lookup(context.Background(), "123", "key3")
